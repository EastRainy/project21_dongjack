...
class Back extends JPanel {
	...
	public void paintComponent(Graphics g){
		Image img = Toolkit.getDefaultToolkit().getImage("images/christmas/christmas.jpg"); // 배경이미지
		g.drawImage(img, 0, 0, this);
		Image img1 = Toolkit.getDefaultToolkit().getImage("images/christmas/bbe.png"); // 이미지를 넣어줌
